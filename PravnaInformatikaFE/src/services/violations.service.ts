...
export class ViolationService {
    ...
    private readonly violationMap: { [key: string]: string } = {
        ...
        'failure_to_provide_support_aggravated': 'Otežani oblik nedavanja izdržavanja',

        // Article 222 - Family Obligation Violations
        'family_obligation_violation_basic': 'Osnovni oblik kršenja porodičnih obaveza',
        'family_obligation_violation_aggravated_health': 'Kršenje porodičnih obaveza sa zdravstvenim posledicama',
        'family_obligation_violation_aggravated_death': 'Kršenje porodičnih obaveza sa smrtnim ishodom',

        // Article 216 - Extramarital Unions with Minors
        'extramarital_union_with_minor_basic': 'Vanbračna zajednica sa maloletnikom',
        'enabling_minor_extramarital_union': 'Omogućavanje vanbračne zajednice maloletnika',
        'enabling_minor_extramarital_union_aggravated': 'Otežano omogućavanje vanbračne zajednice maloletnika',
        ...
        'domestic_violence_aggravated_weapon': 'Nasilje u porodici sa oružjem ili u prisustvu deteta',
        ...
        'domestic_violence_protection_violation': 'Kršenje mera zaštite od nasilja u porodici'
    };
