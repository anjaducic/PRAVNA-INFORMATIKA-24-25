...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:lc="http://ftn.uns.ac.rs/legal-case" exclude-result-prefixes="xs" version="2.0">
            ...
            <Implies ruletype="defeasiblerule">
                ...
                <body>
                    <Atom>
                        <op>
                            <Rel>
                                <xsl:value-of select="//lrml:PrescriptiveStatement[@key=$targetPrescriptiveStatementKey]//ruleml:then//ruleml:Rel"/>
                            </Rel>
                        </op>
                        <slot>
                            <Ind uri="defendant"/>
                ...
                <head>
                    <Atom>
                        <op>
                            <Rel>
                                <xsl:value-of select="replace(//lrml:PenaltyStatement[@key=$penaltyKey]//ruleml:Rel/@iri,'^(:)','')"/>
                            </Rel>
                        </op>
                        <slot>
                            <Ind uri="value"/>
                            <Data xsi:type="xs:integer">
                                <xsl:value-of select="//lrml:PenaltyStatement[@key=$penaltyKey]//ruleml:Ind"/>
                            </Data>
                        </slot>
                    </Atom>
                </head>
