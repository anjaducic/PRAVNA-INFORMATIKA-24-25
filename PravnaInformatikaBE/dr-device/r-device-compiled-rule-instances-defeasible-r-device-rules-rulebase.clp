([pen22-defeasibly-dot] of derived-attribute-rule
   (pos-name pen22-defeasibly-dot-gen500)
   (depends-on declare max_imprisonment domestic_violence_protection_violation max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen22] ) ) ) ?gen454 <- ( max_imprisonment ( value 365 ) ( positive 1 ) ( positive-derivator pen22 $? ) ) ( test ( eq ( class ?gen454 ) max_imprisonment ) ) ( not ( and ?gen461 <- ( domestic_violence_protection_violation ( defendant ?Defendant ) ( positive ?gen460 & : ( >= ?gen460 1 ) ) ) ?gen454 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen456 & : ( not ( member$ pen22 $?gen456 ) ) ) ) ) ) => ?gen454 <- ( max_imprisonment ( positive 0 ) )"))

([pen22-defeasibly] of derived-attribute-rule
   (pos-name pen22-defeasibly-gen502)
   (depends-on declare domestic_violence_protection_violation max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen22] ) ) ) ?gen461 <- ( domestic_violence_protection_violation ( defendant ?Defendant ) ( positive ?gen460 & : ( >= ?gen460 1 ) ) ) ?gen454 <- ( max_imprisonment ( value 365 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen456 & : ( not ( member$ pen22 $?gen456 ) ) ) ) ( test ( eq ( class ?gen454 ) max_imprisonment ) ) => ?gen454 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen22 ?gen461 ) )"))

([pen22-overruled-dot] of derived-attribute-rule
   (pos-name pen22-overruled-dot-gen504)
   (depends-on declare max_imprisonment domestic_violence_protection_violation max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen22] ) ) ) ?gen454 <- ( max_imprisonment ( value 365 ) ( negative-support $?gen457 ) ( negative-overruled $?gen458 & : ( subseq-pos ( create$ pen22-overruled $?gen457 $$$ $?gen458 ) ) ) ) ( test ( eq ( class ?gen454 ) max_imprisonment ) ) ( not ( and ?gen461 <- ( domestic_violence_protection_violation ( defendant ?Defendant ) ( positive ?gen460 & : ( >= ?gen460 1 ) ) ) ?gen454 <- ( max_imprisonment ( positive-defeated $?gen456 & : ( not ( member$ pen22 $?gen456 ) ) ) ) ) ) => ( calc ( bind $?gen459 ( delete-member$ $?gen458 ( create$ pen22-overruled $?gen457 ) ) ) ) ?gen454 <- ( max_imprisonment ( negative-overruled $?gen459 ) )"))

([pen22-overruled] of derived-attribute-rule
   (pos-name pen22-overruled-gen506)
   (depends-on declare domestic_violence_protection_violation max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen22] ) ) ) ?gen461 <- ( domestic_violence_protection_violation ( defendant ?Defendant ) ( positive ?gen460 & : ( >= ?gen460 1 ) ) ) ?gen454 <- ( max_imprisonment ( value 365 ) ( negative-support $?gen457 ) ( negative-overruled $?gen458 & : ( not ( subseq-pos ( create$ pen22-overruled $?gen457 $$$ $?gen458 ) ) ) ) ( positive-defeated $?gen456 & : ( not ( member$ pen22 $?gen456 ) ) ) ) ( test ( eq ( class ?gen454 ) max_imprisonment ) ) => ( calc ( bind $?gen459 ( create$ pen22-overruled $?gen457 $?gen458 ) ) ) ?gen454 <- ( max_imprisonment ( negative-overruled $?gen459 ) )"))

([pen22-support] of derived-attribute-rule
   (pos-name pen22-support-gen508)
   (depends-on declare domestic_violence_protection_violation max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen22] ) ) ) ?gen453 <- ( domestic_violence_protection_violation ( defendant ?Defendant ) ) ?gen454 <- ( max_imprisonment ( value 365 ) ( positive-support $?gen456 & : ( not ( subseq-pos ( create$ pen22 ?gen453 $$$ $?gen456 ) ) ) ) ) ( test ( eq ( class ?gen454 ) max_imprisonment ) ) => ( calc ( bind $?gen459 ( create$ pen22 ?gen453 $?gen456 ) ) ) ?gen454 <- ( max_imprisonment ( positive-support $?gen459 ) )"))

([pen21-defeasibly-dot] of derived-attribute-rule
   (pos-name pen21-defeasibly-dot-gen510)
   (depends-on declare max_imprisonment domestic_violence_aggravated_death max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen21] ) ) ) ?gen445 <- ( max_imprisonment ( value 5475 ) ( positive 1 ) ( positive-derivator pen21 $? ) ) ( test ( eq ( class ?gen445 ) max_imprisonment ) ) ( not ( and ?gen452 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ( positive ?gen451 & : ( >= ?gen451 1 ) ) ) ?gen445 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen447 & : ( not ( member$ pen21 $?gen447 ) ) ) ) ) ) => ?gen445 <- ( max_imprisonment ( positive 0 ) )"))

([pen21-defeasibly] of derived-attribute-rule
   (pos-name pen21-defeasibly-gen512)
   (depends-on declare domestic_violence_aggravated_death max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen21] ) ) ) ?gen452 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ( positive ?gen451 & : ( >= ?gen451 1 ) ) ) ?gen445 <- ( max_imprisonment ( value 5475 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen447 & : ( not ( member$ pen21 $?gen447 ) ) ) ) ( test ( eq ( class ?gen445 ) max_imprisonment ) ) => ?gen445 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen21 ?gen452 ) )"))

([pen21-overruled-dot] of derived-attribute-rule
   (pos-name pen21-overruled-dot-gen514)
   (depends-on declare max_imprisonment domestic_violence_aggravated_death max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen21] ) ) ) ?gen445 <- ( max_imprisonment ( value 5475 ) ( negative-support $?gen448 ) ( negative-overruled $?gen449 & : ( subseq-pos ( create$ pen21-overruled $?gen448 $$$ $?gen449 ) ) ) ) ( test ( eq ( class ?gen445 ) max_imprisonment ) ) ( not ( and ?gen452 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ( positive ?gen451 & : ( >= ?gen451 1 ) ) ) ?gen445 <- ( max_imprisonment ( positive-defeated $?gen447 & : ( not ( member$ pen21 $?gen447 ) ) ) ) ) ) => ( calc ( bind $?gen450 ( delete-member$ $?gen449 ( create$ pen21-overruled $?gen448 ) ) ) ) ?gen445 <- ( max_imprisonment ( negative-overruled $?gen450 ) )"))

([pen21-overruled] of derived-attribute-rule
   (pos-name pen21-overruled-gen516)
   (depends-on declare domestic_violence_aggravated_death max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen21] ) ) ) ?gen452 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ( positive ?gen451 & : ( >= ?gen451 1 ) ) ) ?gen445 <- ( max_imprisonment ( value 5475 ) ( negative-support $?gen448 ) ( negative-overruled $?gen449 & : ( not ( subseq-pos ( create$ pen21-overruled $?gen448 $$$ $?gen449 ) ) ) ) ( positive-defeated $?gen447 & : ( not ( member$ pen21 $?gen447 ) ) ) ) ( test ( eq ( class ?gen445 ) max_imprisonment ) ) => ( calc ( bind $?gen450 ( create$ pen21-overruled $?gen448 $?gen449 ) ) ) ?gen445 <- ( max_imprisonment ( negative-overruled $?gen450 ) )"))

([pen21-support] of derived-attribute-rule
   (pos-name pen21-support-gen518)
   (depends-on declare domestic_violence_aggravated_death max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen21] ) ) ) ?gen444 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ) ?gen445 <- ( max_imprisonment ( value 5475 ) ( positive-support $?gen447 & : ( not ( subseq-pos ( create$ pen21 ?gen444 $$$ $?gen447 ) ) ) ) ) ( test ( eq ( class ?gen445 ) max_imprisonment ) ) => ( calc ( bind $?gen450 ( create$ pen21 ?gen444 $?gen447 ) ) ) ?gen445 <- ( max_imprisonment ( positive-support $?gen450 ) )"))

([pen20-defeasibly-dot] of derived-attribute-rule
   (pos-name pen20-defeasibly-dot-gen520)
   (depends-on declare min_imprisonment domestic_violence_aggravated_death min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen20] ) ) ) ?gen436 <- ( min_imprisonment ( value 1825 ) ( positive 1 ) ( positive-derivator pen20 $? ) ) ( test ( eq ( class ?gen436 ) min_imprisonment ) ) ( not ( and ?gen443 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ( positive ?gen442 & : ( >= ?gen442 1 ) ) ) ?gen436 <- ( min_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen438 & : ( not ( member$ pen20 $?gen438 ) ) ) ) ) ) => ?gen436 <- ( min_imprisonment ( positive 0 ) )"))

([pen20-defeasibly] of derived-attribute-rule
   (pos-name pen20-defeasibly-gen522)
   (depends-on declare domestic_violence_aggravated_death min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen20] ) ) ) ?gen443 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ( positive ?gen442 & : ( >= ?gen442 1 ) ) ) ?gen436 <- ( min_imprisonment ( value 1825 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen438 & : ( not ( member$ pen20 $?gen438 ) ) ) ) ( test ( eq ( class ?gen436 ) min_imprisonment ) ) => ?gen436 <- ( min_imprisonment ( positive 1 ) ( positive-derivator pen20 ?gen443 ) )"))

([pen20-overruled-dot] of derived-attribute-rule
   (pos-name pen20-overruled-dot-gen524)
   (depends-on declare min_imprisonment domestic_violence_aggravated_death min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen20] ) ) ) ?gen436 <- ( min_imprisonment ( value 1825 ) ( negative-support $?gen439 ) ( negative-overruled $?gen440 & : ( subseq-pos ( create$ pen20-overruled $?gen439 $$$ $?gen440 ) ) ) ) ( test ( eq ( class ?gen436 ) min_imprisonment ) ) ( not ( and ?gen443 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ( positive ?gen442 & : ( >= ?gen442 1 ) ) ) ?gen436 <- ( min_imprisonment ( positive-defeated $?gen438 & : ( not ( member$ pen20 $?gen438 ) ) ) ) ) ) => ( calc ( bind $?gen441 ( delete-member$ $?gen440 ( create$ pen20-overruled $?gen439 ) ) ) ) ?gen436 <- ( min_imprisonment ( negative-overruled $?gen441 ) )"))

([pen20-overruled] of derived-attribute-rule
   (pos-name pen20-overruled-gen526)
   (depends-on declare domestic_violence_aggravated_death min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen20] ) ) ) ?gen443 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ( positive ?gen442 & : ( >= ?gen442 1 ) ) ) ?gen436 <- ( min_imprisonment ( value 1825 ) ( negative-support $?gen439 ) ( negative-overruled $?gen440 & : ( not ( subseq-pos ( create$ pen20-overruled $?gen439 $$$ $?gen440 ) ) ) ) ( positive-defeated $?gen438 & : ( not ( member$ pen20 $?gen438 ) ) ) ) ( test ( eq ( class ?gen436 ) min_imprisonment ) ) => ( calc ( bind $?gen441 ( create$ pen20-overruled $?gen439 $?gen440 ) ) ) ?gen436 <- ( min_imprisonment ( negative-overruled $?gen441 ) )"))

([pen20-support] of derived-attribute-rule
   (pos-name pen20-support-gen528)
   (depends-on declare domestic_violence_aggravated_death min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen20] ) ) ) ?gen435 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ) ?gen436 <- ( min_imprisonment ( value 1825 ) ( positive-support $?gen438 & : ( not ( subseq-pos ( create$ pen20 ?gen435 $$$ $?gen438 ) ) ) ) ) ( test ( eq ( class ?gen436 ) min_imprisonment ) ) => ( calc ( bind $?gen441 ( create$ pen20 ?gen435 $?gen438 ) ) ) ?gen436 <- ( min_imprisonment ( positive-support $?gen441 ) )"))

([pen19-defeasibly-dot] of derived-attribute-rule
   (pos-name pen19-defeasibly-dot-gen530)
   (depends-on declare max_imprisonment domestic_violence_aggravated_severe max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen19] ) ) ) ?gen427 <- ( max_imprisonment ( value 2920 ) ( positive 1 ) ( positive-derivator pen19 $? ) ) ( test ( eq ( class ?gen427 ) max_imprisonment ) ) ( not ( and ?gen434 <- ( domestic_violence_aggravated_severe ( defendant ?Defendant ) ( positive ?gen433 & : ( >= ?gen433 1 ) ) ) ?gen427 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen429 & : ( not ( member$ pen19 $?gen429 ) ) ) ) ) ) => ?gen427 <- ( max_imprisonment ( positive 0 ) )"))

([pen19-defeasibly] of derived-attribute-rule
   (pos-name pen19-defeasibly-gen532)
   (depends-on declare domestic_violence_aggravated_severe max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen19] ) ) ) ?gen434 <- ( domestic_violence_aggravated_severe ( defendant ?Defendant ) ( positive ?gen433 & : ( >= ?gen433 1 ) ) ) ?gen427 <- ( max_imprisonment ( value 2920 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen429 & : ( not ( member$ pen19 $?gen429 ) ) ) ) ( test ( eq ( class ?gen427 ) max_imprisonment ) ) => ?gen427 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen19 ?gen434 ) )"))

([pen19-overruled-dot] of derived-attribute-rule
   (pos-name pen19-overruled-dot-gen534)
   (depends-on declare max_imprisonment domestic_violence_aggravated_severe max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen19] ) ) ) ?gen427 <- ( max_imprisonment ( value 2920 ) ( negative-support $?gen430 ) ( negative-overruled $?gen431 & : ( subseq-pos ( create$ pen19-overruled $?gen430 $$$ $?gen431 ) ) ) ) ( test ( eq ( class ?gen427 ) max_imprisonment ) ) ( not ( and ?gen434 <- ( domestic_violence_aggravated_severe ( defendant ?Defendant ) ( positive ?gen433 & : ( >= ?gen433 1 ) ) ) ?gen427 <- ( max_imprisonment ( positive-defeated $?gen429 & : ( not ( member$ pen19 $?gen429 ) ) ) ) ) ) => ( calc ( bind $?gen432 ( delete-member$ $?gen431 ( create$ pen19-overruled $?gen430 ) ) ) ) ?gen427 <- ( max_imprisonment ( negative-overruled $?gen432 ) )"))

([pen19-overruled] of derived-attribute-rule
   (pos-name pen19-overruled-gen536)
   (depends-on declare domestic_violence_aggravated_severe max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen19] ) ) ) ?gen434 <- ( domestic_violence_aggravated_severe ( defendant ?Defendant ) ( positive ?gen433 & : ( >= ?gen433 1 ) ) ) ?gen427 <- ( max_imprisonment ( value 2920 ) ( negative-support $?gen430 ) ( negative-overruled $?gen431 & : ( not ( subseq-pos ( create$ pen19-overruled $?gen430 $$$ $?gen431 ) ) ) ) ( positive-defeated $?gen429 & : ( not ( member$ pen19 $?gen429 ) ) ) ) ( test ( eq ( class ?gen427 ) max_imprisonment ) ) => ( calc ( bind $?gen432 ( create$ pen19-overruled $?gen430 $?gen431 ) ) ) ?gen427 <- ( max_imprisonment ( negative-overruled $?gen432 ) )"))

([pen19-support] of derived-attribute-rule
   (pos-name pen19-support-gen538)
   (depends-on declare domestic_violence_aggravated_severe max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen19] ) ) ) ?gen426 <- ( domestic_violence_aggravated_severe ( defendant ?Defendant ) ) ?gen427 <- ( max_imprisonment ( value 2920 ) ( positive-support $?gen429 & : ( not ( subseq-pos ( create$ pen19 ?gen426 $$$ $?gen429 ) ) ) ) ) ( test ( eq ( class ?gen427 ) max_imprisonment ) ) => ( calc ( bind $?gen432 ( create$ pen19 ?gen426 $?gen429 ) ) ) ?gen427 <- ( max_imprisonment ( positive-support $?gen432 ) )"))

([pen18-defeasibly-dot] of derived-attribute-rule
   (pos-name pen18-defeasibly-dot-gen560)
   (depends-on declare min_imprisonment domestic_violence_aggravated_weapon min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen18] ) ) ) ?gen400 <- ( min_imprisonment ( value 365 ) ( positive 1 ) ( positive-derivator pen18 $? ) ) ( test ( eq ( class ?gen400 ) min_imprisonment ) ) ( not ( and ?gen407 <- ( domestic_violence_aggravated_weapon ( defendant ?Defendant ) ( positive ?gen406 & : ( >= ?gen406 1 ) ) ) ?gen400 <- ( min_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen402 & : ( not ( member$ pen18 $?gen402 ) ) ) ) ) ) => ?gen400 <- ( min_imprisonment ( positive 0 ) )"))

([pen18-defeasibly] of derived-attribute-rule
   (pos-name pen18-defeasibly-gen562)
   (depends-on declare domestic_violence_aggravated_weapon min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen18] ) ) ) ?gen407 <- ( domestic_violence_aggravated_weapon ( defendant ?Defendant ) ( positive ?gen406 & : ( >= ?gen406 1 ) ) ) ?gen400 <- ( min_imprisonment ( value 365 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen402 & : ( not ( member$ pen18 $?gen402 ) ) ) ) ( test ( eq ( class ?gen400 ) min_imprisonment ) ) => ?gen400 <- ( min_imprisonment ( positive 1 ) ( positive-derivator pen18 ?gen407 ) )"))

([pen18-overruled-dot] of derived-attribute-rule
   (pos-name pen18-overruled-dot-gen564)
   (depends-on declare min_imprisonment domestic_violence_aggravated_weapon min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen18] ) ) ) ?gen400 <- ( min_imprisonment ( value 365 ) ( negative-support $?gen403 ) ( negative-overruled $?gen404 & : ( subseq-pos ( create$ pen18-overruled $?gen403 $$$ $?gen404 ) ) ) ) ( test ( eq ( class ?gen400 ) min_imprisonment ) ) ( not ( and ?gen407 <- ( domestic_violence_aggravated_weapon ( defendant ?Defendant ) ( positive ?gen406 & : ( >= ?gen406 1 ) ) ) ?gen400 <- ( min_imprisonment ( positive-defeated $?gen402 & : ( not ( member$ pen18 $?gen402 ) ) ) ) ) ) => ( calc ( bind $?gen405 ( delete-member$ $?gen404 ( create$ pen18-overruled $?gen403 ) ) ) ) ?gen400 <- ( min_imprisonment ( negative-overruled $?gen405 ) )"))

([pen18-overruled] of derived-attribute-rule
   (pos-name pen18-overruled-gen566)
   (depends-on declare domestic_violence_aggravated_weapon min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen18] ) ) ) ?gen407 <- ( domestic_violence_aggravated_weapon ( defendant ?Defendant ) ( positive ?gen406 & : ( >= ?gen406 1 ) ) ) ?gen400 <- ( min_imprisonment ( value 365 ) ( negative-support $?gen403 ) ( negative-overruled $?gen404 & : ( not ( subseq-pos ( create$ pen18-overruled $?gen403 $$$ $?gen404 ) ) ) ) ( positive-defeated $?gen402 & : ( not ( member$ pen18 $?gen402 ) ) ) ) ( test ( eq ( class ?gen400 ) min_imprisonment ) ) => ( calc ( bind $?gen405 ( create$ pen18-overruled $?gen403 $?gen404 ) ) ) ?gen400 <- ( min_imprisonment ( negative-overruled $?gen405 ) )"))

([pen18-support] of derived-attribute-rule
   (pos-name pen18-support-gen568)
   (depends-on declare domestic_violence_aggravated_weapon min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen18] ) ) ) ?gen399 <- ( domestic_violence_aggravated_weapon ( defendant ?Defendant ) ) ?gen400 <- ( min_imprisonment ( value 365 ) ( positive-support $?gen402 & : ( not ( subseq-pos ( create$ pen18 ?gen399 $$$ $?gen402 ) ) ) ) ) ( test ( eq ( class ?gen400 ) min_imprisonment ) ) => ( calc ( bind $?gen405 ( create$ pen18 ?gen399 $?gen402 ) ) ) ?gen400 <- ( min_imprisonment ( positive-support $?gen405 ) )"))

([pen17-defeasibly-dot] of derived-attribute-rule
   (pos-name pen17-defeasibly-dot-gen570)
   (depends-on declare max_imprisonment domestic_violence_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen17] ) ) ) ?gen391 <- ( max_imprisonment ( value 1825 ) ( positive 1 ) ( positive-derivator pen17 $? ) ) ( test ( eq ( class ?gen391 ) max_imprisonment ) ) ( not ( and ?gen398 <- ( domestic_violence_basic ( defendant ?Defendant ) ( positive ?gen397 & : ( >= ?gen397 1 ) ) ) ?gen391 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen393 & : ( not ( member$ pen17 $?gen393 ) ) ) ) ) ) => ?gen391 <- ( max_imprisonment ( positive 0 ) )"))

([pen17-defeasibly] of derived-attribute-rule
   (pos-name pen17-defeasibly-gen572)
   (depends-on declare domestic_violence_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen17] ) ) ) ?gen398 <- ( domestic_violence_basic ( defendant ?Defendant ) ( positive ?gen397 & : ( >= ?gen397 1 ) ) ) ?gen391 <- ( max_imprisonment ( value 1825 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen393 & : ( not ( member$ pen17 $?gen393 ) ) ) ) ( test ( eq ( class ?gen391 ) max_imprisonment ) ) => ?gen391 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen17 ?gen398 ) )"))

([pen17-overruled-dot] of derived-attribute-rule
   (pos-name pen17-overruled-dot-gen574)
   (depends-on declare max_imprisonment domestic_violence_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen17] ) ) ) ?gen391 <- ( max_imprisonment ( value 1825 ) ( negative-support $?gen394 ) ( negative-overruled $?gen395 & : ( subseq-pos ( create$ pen17-overruled $?gen394 $$$ $?gen395 ) ) ) ) ( test ( eq ( class ?gen391 ) max_imprisonment ) ) ( not ( and ?gen398 <- ( domestic_violence_basic ( defendant ?Defendant ) ( positive ?gen397 & : ( >= ?gen397 1 ) ) ) ?gen391 <- ( max_imprisonment ( positive-defeated $?gen393 & : ( not ( member$ pen17 $?gen393 ) ) ) ) ) ) => ( calc ( bind $?gen396 ( delete-member$ $?gen395 ( create$ pen17-overruled $?gen394 ) ) ) ) ?gen391 <- ( max_imprisonment ( negative-overruled $?gen396 ) )"))

([pen17-overruled] of derived-attribute-rule
   (pos-name pen17-overruled-gen576)
   (depends-on declare domestic_violence_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen17] ) ) ) ?gen398 <- ( domestic_violence_basic ( defendant ?Defendant ) ( positive ?gen397 & : ( >= ?gen397 1 ) ) ) ?gen391 <- ( max_imprisonment ( value 1825 ) ( negative-support $?gen394 ) ( negative-overruled $?gen395 & : ( not ( subseq-pos ( create$ pen17-overruled $?gen394 $$$ $?gen395 ) ) ) ) ( positive-defeated $?gen393 & : ( not ( member$ pen17 $?gen393 ) ) ) ) ( test ( eq ( class ?gen391 ) max_imprisonment ) ) => ( calc ( bind $?gen396 ( create$ pen17-overruled $?gen394 $?gen395 ) ) ) ?gen391 <- ( max_imprisonment ( negative-overruled $?gen396 ) )"))

([pen17-support] of derived-attribute-rule
   (pos-name pen17-support-gen578)
   (depends-on declare domestic_violence_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen17] ) ) ) ?gen390 <- ( domestic_violence_basic ( defendant ?Defendant ) ) ?gen391 <- ( max_imprisonment ( value 1825 ) ( positive-support $?gen393 & : ( not ( subseq-pos ( create$ pen17 ?gen390 $$$ $?gen393 ) ) ) ) ) ( test ( eq ( class ?gen391 ) max_imprisonment ) ) => ( calc ( bind $?gen396 ( create$ pen17 ?gen390 $?gen393 ) ) ) ?gen391 <- ( max_imprisonment ( positive-support $?gen396 ) )"))

([pen16-defeasibly-dot] of derived-attribute-rule
   (pos-name pen16-defeasibly-dot-gen580)
   (depends-on declare min_imprisonment domestic_violence_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen16] ) ) ) ?gen382 <- ( min_imprisonment ( value 180 ) ( positive 1 ) ( positive-derivator pen16 $? ) ) ( test ( eq ( class ?gen382 ) min_imprisonment ) ) ( not ( and ?gen389 <- ( domestic_violence_basic ( defendant ?Defendant ) ( positive ?gen388 & : ( >= ?gen388 1 ) ) ) ?gen382 <- ( min_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen384 & : ( not ( member$ pen16 $?gen384 ) ) ) ) ) ) => ?gen382 <- ( min_imprisonment ( positive 0 ) )"))

([pen16-defeasibly] of derived-attribute-rule
   (pos-name pen16-defeasibly-gen582)
   (depends-on declare domestic_violence_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen16] ) ) ) ?gen389 <- ( domestic_violence_basic ( defendant ?Defendant ) ( positive ?gen388 & : ( >= ?gen388 1 ) ) ) ?gen382 <- ( min_imprisonment ( value 180 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen384 & : ( not ( member$ pen16 $?gen384 ) ) ) ) ( test ( eq ( class ?gen382 ) min_imprisonment ) ) => ?gen382 <- ( min_imprisonment ( positive 1 ) ( positive-derivator pen16 ?gen389 ) )"))

([pen16-overruled-dot] of derived-attribute-rule
   (pos-name pen16-overruled-dot-gen584)
   (depends-on declare min_imprisonment domestic_violence_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen16] ) ) ) ?gen382 <- ( min_imprisonment ( value 180 ) ( negative-support $?gen385 ) ( negative-overruled $?gen386 & : ( subseq-pos ( create$ pen16-overruled $?gen385 $$$ $?gen386 ) ) ) ) ( test ( eq ( class ?gen382 ) min_imprisonment ) ) ( not ( and ?gen389 <- ( domestic_violence_basic ( defendant ?Defendant ) ( positive ?gen388 & : ( >= ?gen388 1 ) ) ) ?gen382 <- ( min_imprisonment ( positive-defeated $?gen384 & : ( not ( member$ pen16 $?gen384 ) ) ) ) ) ) => ( calc ( bind $?gen387 ( delete-member$ $?gen386 ( create$ pen16-overruled $?gen385 ) ) ) ) ?gen382 <- ( min_imprisonment ( negative-overruled $?gen387 ) )"))

([pen16-overruled] of derived-attribute-rule
   (pos-name pen16-overruled-gen586)
   (depends-on declare domestic_violence_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen16] ) ) ) ?gen389 <- ( domestic_violence_basic ( defendant ?Defendant ) ( positive ?gen388 & : ( >= ?gen388 1 ) ) ) ?gen382 <- ( min_imprisonment ( value 180 ) ( negative-support $?gen385 ) ( negative-overruled $?gen386 & : ( not ( subseq-pos ( create$ pen16-overruled $?gen385 $$$ $?gen386 ) ) ) ) ( positive-defeated $?gen384 & : ( not ( member$ pen16 $?gen384 ) ) ) ) ( test ( eq ( class ?gen382 ) min_imprisonment ) ) => ( calc ( bind $?gen387 ( create$ pen16-overruled $?gen385 $?gen386 ) ) ) ?gen382 <- ( min_imprisonment ( negative-overruled $?gen387 ) )"))

([pen16-support] of derived-attribute-rule
   (pos-name pen16-support-gen588)
   (depends-on declare domestic_violence_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen16] ) ) ) ?gen381 <- ( domestic_violence_basic ( defendant ?Defendant ) ) ?gen382 <- ( min_imprisonment ( value 180 ) ( positive-support $?gen384 & : ( not ( subseq-pos ( create$ pen16 ?gen381 $$$ $?gen384 ) ) ) ) ) ( test ( eq ( class ?gen382 ) min_imprisonment ) ) => ( calc ( bind $?gen387 ( create$ pen16 ?gen381 $?gen384 ) ) ) ?gen382 <- ( min_imprisonment ( positive-support $?gen387 ) )"))

([pen15-defeasibly-dot] of derived-attribute-rule
   (pos-name pen15-defeasibly-dot-gen590)
   (depends-on declare max_imprisonment child_abduction_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen15] ) ) ) ?gen373 <- ( max_imprisonment ( value 1825 ) ( positive 1 ) ( positive-derivator pen15 $? ) ) ( test ( eq ( class ?gen373 ) max_imprisonment ) ) ( not ( and ?gen380 <- ( child_abduction_aggravated ( defendant ?Defendant ) ( positive ?gen379 & : ( >= ?gen379 1 ) ) ) ?gen373 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen375 & : ( not ( member$ pen15 $?gen375 ) ) ) ) ) ) => ?gen373 <- ( max_imprisonment ( positive 0 ) )"))

([pen15-defeasibly] of derived-attribute-rule
   (pos-name pen15-defeasibly-gen592)
   (depends-on declare child_abduction_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen15] ) ) ) ?gen380 <- ( child_abduction_aggravated ( defendant ?Defendant ) ( positive ?gen379 & : ( >= ?gen379 1 ) ) ) ?gen373 <- ( max_imprisonment ( value 1825 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen375 & : ( not ( member$ pen15 $?gen375 ) ) ) ) ( test ( eq ( class ?gen373 ) max_imprisonment ) ) => ?gen373 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen15 ?gen380 ) )"))

([pen15-overruled-dot] of derived-attribute-rule
   (pos-name pen15-overruled-dot-gen594)
   (depends-on declare max_imprisonment child_abduction_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen15] ) ) ) ?gen373 <- ( max_imprisonment ( value 1825 ) ( negative-support $?gen376 ) ( negative-overruled $?gen377 & : ( subseq-pos ( create$ pen15-overruled $?gen376 $$$ $?gen377 ) ) ) ) ( test ( eq ( class ?gen373 ) max_imprisonment ) ) ( not ( and ?gen380 <- ( child_abduction_aggravated ( defendant ?Defendant ) ( positive ?gen379 & : ( >= ?gen379 1 ) ) ) ?gen373 <- ( max_imprisonment ( positive-defeated $?gen375 & : ( not ( member$ pen15 $?gen375 ) ) ) ) ) ) => ( calc ( bind $?gen378 ( delete-member$ $?gen377 ( create$ pen15-overruled $?gen376 ) ) ) ) ?gen373 <- ( max_imprisonment ( negative-overruled $?gen378 ) )"))

([pen15-overruled] of derived-attribute-rule
   (pos-name pen15-overruled-gen596)
   (depends-on declare child_abduction_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen15] ) ) ) ?gen380 <- ( child_abduction_aggravated ( defendant ?Defendant ) ( positive ?gen379 & : ( >= ?gen379 1 ) ) ) ?gen373 <- ( max_imprisonment ( value 1825 ) ( negative-support $?gen376 ) ( negative-overruled $?gen377 & : ( not ( subseq-pos ( create$ pen15-overruled $?gen376 $$$ $?gen377 ) ) ) ) ( positive-defeated $?gen375 & : ( not ( member$ pen15 $?gen375 ) ) ) ) ( test ( eq ( class ?gen373 ) max_imprisonment ) ) => ( calc ( bind $?gen378 ( create$ pen15-overruled $?gen376 $?gen377 ) ) ) ?gen373 <- ( max_imprisonment ( negative-overruled $?gen378 ) )"))

([pen15-support] of derived-attribute-rule
   (pos-name pen15-support-gen598)
   (depends-on declare child_abduction_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen15] ) ) ) ?gen372 <- ( child_abduction_aggravated ( defendant ?Defendant ) ) ?gen373 <- ( max_imprisonment ( value 1825 ) ( positive-support $?gen375 & : ( not ( subseq-pos ( create$ pen15 ?gen372 $$$ $?gen375 ) ) ) ) ) ( test ( eq ( class ?gen373 ) max_imprisonment ) ) => ( calc ( bind $?gen378 ( create$ pen15 ?gen372 $?gen375 ) ) ) ?gen373 <- ( max_imprisonment ( positive-support $?gen378 ) )"))

([pen14-defeasibly-dot] of derived-attribute-rule
   (pos-name pen14-defeasibly-dot-gen600)
   (depends-on declare min_imprisonment child_abduction_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen14] ) ) ) ?gen364 <- ( min_imprisonment ( value 90 ) ( positive 1 ) ( positive-derivator pen14 $? ) ) ( test ( eq ( class ?gen364 ) min_imprisonment ) ) ( not ( and ?gen371 <- ( child_abduction_aggravated ( defendant ?Defendant ) ( positive ?gen370 & : ( >= ?gen370 1 ) ) ) ?gen364 <- ( min_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen366 & : ( not ( member$ pen14 $?gen366 ) ) ) ) ) ) => ?gen364 <- ( min_imprisonment ( positive 0 ) )"))

([pen14-defeasibly] of derived-attribute-rule
   (pos-name pen14-defeasibly-gen602)
   (depends-on declare child_abduction_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen14] ) ) ) ?gen371 <- ( child_abduction_aggravated ( defendant ?Defendant ) ( positive ?gen370 & : ( >= ?gen370 1 ) ) ) ?gen364 <- ( min_imprisonment ( value 90 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen366 & : ( not ( member$ pen14 $?gen366 ) ) ) ) ( test ( eq ( class ?gen364 ) min_imprisonment ) ) => ?gen364 <- ( min_imprisonment ( positive 1 ) ( positive-derivator pen14 ?gen371 ) )"))

([pen14-overruled-dot] of derived-attribute-rule
   (pos-name pen14-overruled-dot-gen604)
   (depends-on declare min_imprisonment child_abduction_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen14] ) ) ) ?gen364 <- ( min_imprisonment ( value 90 ) ( negative-support $?gen367 ) ( negative-overruled $?gen368 & : ( subseq-pos ( create$ pen14-overruled $?gen367 $$$ $?gen368 ) ) ) ) ( test ( eq ( class ?gen364 ) min_imprisonment ) ) ( not ( and ?gen371 <- ( child_abduction_aggravated ( defendant ?Defendant ) ( positive ?gen370 & : ( >= ?gen370 1 ) ) ) ?gen364 <- ( min_imprisonment ( positive-defeated $?gen366 & : ( not ( member$ pen14 $?gen366 ) ) ) ) ) ) => ( calc ( bind $?gen369 ( delete-member$ $?gen368 ( create$ pen14-overruled $?gen367 ) ) ) ) ?gen364 <- ( min_imprisonment ( negative-overruled $?gen369 ) )"))

([pen14-overruled] of derived-attribute-rule
   (pos-name pen14-overruled-gen606)
   (depends-on declare child_abduction_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen14] ) ) ) ?gen371 <- ( child_abduction_aggravated ( defendant ?Defendant ) ( positive ?gen370 & : ( >= ?gen370 1 ) ) ) ?gen364 <- ( min_imprisonment ( value 90 ) ( negative-support $?gen367 ) ( negative-overruled $?gen368 & : ( not ( subseq-pos ( create$ pen14-overruled $?gen367 $$$ $?gen368 ) ) ) ) ( positive-defeated $?gen366 & : ( not ( member$ pen14 $?gen366 ) ) ) ) ( test ( eq ( class ?gen364 ) min_imprisonment ) ) => ( calc ( bind $?gen369 ( create$ pen14-overruled $?gen367 $?gen368 ) ) ) ?gen364 <- ( min_imprisonment ( negative-overruled $?gen369 ) )"))

([pen14-support] of derived-attribute-rule
   (pos-name pen14-support-gen608)
   (depends-on declare child_abduction_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen14] ) ) ) ?gen363 <- ( child_abduction_aggravated ( defendant ?Defendant ) ) ?gen364 <- ( min_imprisonment ( value 90 ) ( positive-support $?gen366 & : ( not ( subseq-pos ( create$ pen14 ?gen363 $$$ $?gen366 ) ) ) ) ) ( test ( eq ( class ?gen364 ) min_imprisonment ) ) => ( calc ( bind $?gen369 ( create$ pen14 ?gen363 $?gen366 ) ) ) ?gen364 <- ( min_imprisonment ( positive-support $?gen369 ) )"))

([pen13-defeasibly-dot] of derived-attribute-rule
   (pos-name pen13-defeasibly-dot-gen610)
   (depends-on declare max_imprisonment preventing_child_contact max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen13] ) ) ) ?gen355 <- ( max_imprisonment ( value 365 ) ( positive 1 ) ( positive-derivator pen13 $? ) ) ( test ( eq ( class ?gen355 ) max_imprisonment ) ) ( not ( and ?gen362 <- ( preventing_child_contact ( defendant ?Defendant ) ( positive ?gen361 & : ( >= ?gen361 1 ) ) ) ?gen355 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen357 & : ( not ( member$ pen13 $?gen357 ) ) ) ) ) ) => ?gen355 <- ( max_imprisonment ( positive 0 ) )"))

([pen13-defeasibly] of derived-attribute-rule
   (pos-name pen13-defeasibly-gen612)
   (depends-on declare preventing_child_contact max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen13] ) ) ) ?gen362 <- ( preventing_child_contact ( defendant ?Defendant ) ( positive ?gen361 & : ( >= ?gen361 1 ) ) ) ?gen355 <- ( max_imprisonment ( value 365 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen357 & : ( not ( member$ pen13 $?gen357 ) ) ) ) ( test ( eq ( class ?gen355 ) max_imprisonment ) ) => ?gen355 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen13 ?gen362 ) )"))

([pen13-overruled-dot] of derived-attribute-rule
   (pos-name pen13-overruled-dot-gen614)
   (depends-on declare max_imprisonment preventing_child_contact max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen13] ) ) ) ?gen355 <- ( max_imprisonment ( value 365 ) ( negative-support $?gen358 ) ( negative-overruled $?gen359 & : ( subseq-pos ( create$ pen13-overruled $?gen358 $$$ $?gen359 ) ) ) ) ( test ( eq ( class ?gen355 ) max_imprisonment ) ) ( not ( and ?gen362 <- ( preventing_child_contact ( defendant ?Defendant ) ( positive ?gen361 & : ( >= ?gen361 1 ) ) ) ?gen355 <- ( max_imprisonment ( positive-defeated $?gen357 & : ( not ( member$ pen13 $?gen357 ) ) ) ) ) ) => ( calc ( bind $?gen360 ( delete-member$ $?gen359 ( create$ pen13-overruled $?gen358 ) ) ) ) ?gen355 <- ( max_imprisonment ( negative-overruled $?gen360 ) )"))

([pen13-overruled] of derived-attribute-rule
   (pos-name pen13-overruled-gen616)
   (depends-on declare preventing_child_contact max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen13] ) ) ) ?gen362 <- ( preventing_child_contact ( defendant ?Defendant ) ( positive ?gen361 & : ( >= ?gen361 1 ) ) ) ?gen355 <- ( max_imprisonment ( value 365 ) ( negative-support $?gen358 ) ( negative-overruled $?gen359 & : ( not ( subseq-pos ( create$ pen13-overruled $?gen358 $$$ $?gen359 ) ) ) ) ( positive-defeated $?gen357 & : ( not ( member$ pen13 $?gen357 ) ) ) ) ( test ( eq ( class ?gen355 ) max_imprisonment ) ) => ( calc ( bind $?gen360 ( create$ pen13-overruled $?gen358 $?gen359 ) ) ) ?gen355 <- ( max_imprisonment ( negative-overruled $?gen360 ) )"))

([pen13-support] of derived-attribute-rule
   (pos-name pen13-support-gen618)
   (depends-on declare preventing_child_contact max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen13] ) ) ) ?gen354 <- ( preventing_child_contact ( defendant ?Defendant ) ) ?gen355 <- ( max_imprisonment ( value 365 ) ( positive-support $?gen357 & : ( not ( subseq-pos ( create$ pen13 ?gen354 $$$ $?gen357 ) ) ) ) ) ( test ( eq ( class ?gen355 ) max_imprisonment ) ) => ( calc ( bind $?gen360 ( create$ pen13 ?gen354 $?gen357 ) ) ) ?gen355 <- ( max_imprisonment ( positive-support $?gen360 ) )"))

([pen12-defeasibly-dot] of derived-attribute-rule
   (pos-name pen12-defeasibly-dot-gen620)
   (depends-on declare max_imprisonment child_abduction_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen12] ) ) ) ?gen346 <- ( max_imprisonment ( value 730 ) ( positive 1 ) ( positive-derivator pen12 $? ) ) ( test ( eq ( class ?gen346 ) max_imprisonment ) ) ( not ( and ?gen353 <- ( child_abduction_basic ( defendant ?Defendant ) ( positive ?gen352 & : ( >= ?gen352 1 ) ) ) ?gen346 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen348 & : ( not ( member$ pen12 $?gen348 ) ) ) ) ) ) => ?gen346 <- ( max_imprisonment ( positive 0 ) )"))

([pen12-defeasibly] of derived-attribute-rule
   (pos-name pen12-defeasibly-gen622)
   (depends-on declare child_abduction_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen12] ) ) ) ?gen353 <- ( child_abduction_basic ( defendant ?Defendant ) ( positive ?gen352 & : ( >= ?gen352 1 ) ) ) ?gen346 <- ( max_imprisonment ( value 730 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen348 & : ( not ( member$ pen12 $?gen348 ) ) ) ) ( test ( eq ( class ?gen346 ) max_imprisonment ) ) => ?gen346 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen12 ?gen353 ) )"))

([pen12-overruled-dot] of derived-attribute-rule
   (pos-name pen12-overruled-dot-gen624)
   (depends-on declare max_imprisonment child_abduction_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen12] ) ) ) ?gen346 <- ( max_imprisonment ( value 730 ) ( negative-support $?gen349 ) ( negative-overruled $?gen350 & : ( subseq-pos ( create$ pen12-overruled $?gen349 $$$ $?gen350 ) ) ) ) ( test ( eq ( class ?gen346 ) max_imprisonment ) ) ( not ( and ?gen353 <- ( child_abduction_basic ( defendant ?Defendant ) ( positive ?gen352 & : ( >= ?gen352 1 ) ) ) ?gen346 <- ( max_imprisonment ( positive-defeated $?gen348 & : ( not ( member$ pen12 $?gen348 ) ) ) ) ) ) => ( calc ( bind $?gen351 ( delete-member$ $?gen350 ( create$ pen12-overruled $?gen349 ) ) ) ) ?gen346 <- ( max_imprisonment ( negative-overruled $?gen351 ) )"))

([pen12-overruled] of derived-attribute-rule
   (pos-name pen12-overruled-gen626)
   (depends-on declare child_abduction_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen12] ) ) ) ?gen353 <- ( child_abduction_basic ( defendant ?Defendant ) ( positive ?gen352 & : ( >= ?gen352 1 ) ) ) ?gen346 <- ( max_imprisonment ( value 730 ) ( negative-support $?gen349 ) ( negative-overruled $?gen350 & : ( not ( subseq-pos ( create$ pen12-overruled $?gen349 $$$ $?gen350 ) ) ) ) ( positive-defeated $?gen348 & : ( not ( member$ pen12 $?gen348 ) ) ) ) ( test ( eq ( class ?gen346 ) max_imprisonment ) ) => ( calc ( bind $?gen351 ( create$ pen12-overruled $?gen349 $?gen350 ) ) ) ?gen346 <- ( max_imprisonment ( negative-overruled $?gen351 ) )"))

([pen12-support] of derived-attribute-rule
   (pos-name pen12-support-gen628)
   (depends-on declare child_abduction_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen12] ) ) ) ?gen345 <- ( child_abduction_basic ( defendant ?Defendant ) ) ?gen346 <- ( max_imprisonment ( value 730 ) ( positive-support $?gen348 & : ( not ( subseq-pos ( create$ pen12 ?gen345 $$$ $?gen348 ) ) ) ) ) ( test ( eq ( class ?gen346 ) max_imprisonment ) ) => ( calc ( bind $?gen351 ( create$ pen12 ?gen345 $?gen348 ) ) ) ?gen346 <- ( max_imprisonment ( positive-support $?gen351 ) )"))

([pen11-defeasibly-dot] of derived-attribute-rule
   (pos-name pen11-defeasibly-dot-gen630)
   (depends-on declare max_imprisonment enabling_minor_extramarital_union_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen11] ) ) ) ?gen337 <- ( max_imprisonment ( value 1825 ) ( positive 1 ) ( positive-derivator pen11 $? ) ) ( test ( eq ( class ?gen337 ) max_imprisonment ) ) ( not ( and ?gen344 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ( positive ?gen343 & : ( >= ?gen343 1 ) ) ) ?gen337 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen339 & : ( not ( member$ pen11 $?gen339 ) ) ) ) ) ) => ?gen337 <- ( max_imprisonment ( positive 0 ) )"))

([pen11-defeasibly] of derived-attribute-rule
   (pos-name pen11-defeasibly-gen632)
   (depends-on declare enabling_minor_extramarital_union_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen11] ) ) ) ?gen344 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ( positive ?gen343 & : ( >= ?gen343 1 ) ) ) ?gen337 <- ( max_imprisonment ( value 1825 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen339 & : ( not ( member$ pen11 $?gen339 ) ) ) ) ( test ( eq ( class ?gen337 ) max_imprisonment ) ) => ?gen337 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen11 ?gen344 ) )"))

([pen11-overruled-dot] of derived-attribute-rule
   (pos-name pen11-overruled-dot-gen634)
   (depends-on declare max_imprisonment enabling_minor_extramarital_union_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen11] ) ) ) ?gen337 <- ( max_imprisonment ( value 1825 ) ( negative-support $?gen340 ) ( negative-overruled $?gen341 & : ( subseq-pos ( create$ pen11-overruled $?gen340 $$$ $?gen341 ) ) ) ) ( test ( eq ( class ?gen337 ) max_imprisonment ) ) ( not ( and ?gen344 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ( positive ?gen343 & : ( >= ?gen343 1 ) ) ) ?gen337 <- ( max_imprisonment ( positive-defeated $?gen339 & : ( not ( member$ pen11 $?gen339 ) ) ) ) ) ) => ( calc ( bind $?gen342 ( delete-member$ $?gen341 ( create$ pen11-overruled $?gen340 ) ) ) ) ?gen337 <- ( max_imprisonment ( negative-overruled $?gen342 ) )"))

([pen11-overruled] of derived-attribute-rule
   (pos-name pen11-overruled-gen636)
   (depends-on declare enabling_minor_extramarital_union_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen11] ) ) ) ?gen344 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ( positive ?gen343 & : ( >= ?gen343 1 ) ) ) ?gen337 <- ( max_imprisonment ( value 1825 ) ( negative-support $?gen340 ) ( negative-overruled $?gen341 & : ( not ( subseq-pos ( create$ pen11-overruled $?gen340 $$$ $?gen341 ) ) ) ) ( positive-defeated $?gen339 & : ( not ( member$ pen11 $?gen339 ) ) ) ) ( test ( eq ( class ?gen337 ) max_imprisonment ) ) => ( calc ( bind $?gen342 ( create$ pen11-overruled $?gen340 $?gen341 ) ) ) ?gen337 <- ( max_imprisonment ( negative-overruled $?gen342 ) )"))

([pen11-support] of derived-attribute-rule
   (pos-name pen11-support-gen638)
   (depends-on declare enabling_minor_extramarital_union_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen11] ) ) ) ?gen336 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ) ?gen337 <- ( max_imprisonment ( value 1825 ) ( positive-support $?gen339 & : ( not ( subseq-pos ( create$ pen11 ?gen336 $$$ $?gen339 ) ) ) ) ) ( test ( eq ( class ?gen337 ) max_imprisonment ) ) => ( calc ( bind $?gen342 ( create$ pen11 ?gen336 $?gen339 ) ) ) ?gen337 <- ( max_imprisonment ( positive-support $?gen342 ) )"))

([pen10-defeasibly-dot] of derived-attribute-rule
   (pos-name pen10-defeasibly-dot-gen640)
   (depends-on declare min_imprisonment enabling_minor_extramarital_union_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen10] ) ) ) ?gen328 <- ( min_imprisonment ( value 180 ) ( positive 1 ) ( positive-derivator pen10 $? ) ) ( test ( eq ( class ?gen328 ) min_imprisonment ) ) ( not ( and ?gen335 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ( positive ?gen334 & : ( >= ?gen334 1 ) ) ) ?gen328 <- ( min_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen330 & : ( not ( member$ pen10 $?gen330 ) ) ) ) ) ) => ?gen328 <- ( min_imprisonment ( positive 0 ) )"))

([pen10-defeasibly] of derived-attribute-rule
   (pos-name pen10-defeasibly-gen642)
   (depends-on declare enabling_minor_extramarital_union_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen10] ) ) ) ?gen335 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ( positive ?gen334 & : ( >= ?gen334 1 ) ) ) ?gen328 <- ( min_imprisonment ( value 180 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen330 & : ( not ( member$ pen10 $?gen330 ) ) ) ) ( test ( eq ( class ?gen328 ) min_imprisonment ) ) => ?gen328 <- ( min_imprisonment ( positive 1 ) ( positive-derivator pen10 ?gen335 ) )"))

([pen10-overruled-dot] of derived-attribute-rule
   (pos-name pen10-overruled-dot-gen644)
   (depends-on declare min_imprisonment enabling_minor_extramarital_union_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen10] ) ) ) ?gen328 <- ( min_imprisonment ( value 180 ) ( negative-support $?gen331 ) ( negative-overruled $?gen332 & : ( subseq-pos ( create$ pen10-overruled $?gen331 $$$ $?gen332 ) ) ) ) ( test ( eq ( class ?gen328 ) min_imprisonment ) ) ( not ( and ?gen335 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ( positive ?gen334 & : ( >= ?gen334 1 ) ) ) ?gen328 <- ( min_imprisonment ( positive-defeated $?gen330 & : ( not ( member$ pen10 $?gen330 ) ) ) ) ) ) => ( calc ( bind $?gen333 ( delete-member$ $?gen332 ( create$ pen10-overruled $?gen331 ) ) ) ) ?gen328 <- ( min_imprisonment ( negative-overruled $?gen333 ) )"))

([pen10-overruled] of derived-attribute-rule
   (pos-name pen10-overruled-gen646)
   (depends-on declare enabling_minor_extramarital_union_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen10] ) ) ) ?gen335 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ( positive ?gen334 & : ( >= ?gen334 1 ) ) ) ?gen328 <- ( min_imprisonment ( value 180 ) ( negative-support $?gen331 ) ( negative-overruled $?gen332 & : ( not ( subseq-pos ( create$ pen10-overruled $?gen331 $$$ $?gen332 ) ) ) ) ( positive-defeated $?gen330 & : ( not ( member$ pen10 $?gen330 ) ) ) ) ( test ( eq ( class ?gen328 ) min_imprisonment ) ) => ( calc ( bind $?gen333 ( create$ pen10-overruled $?gen331 $?gen332 ) ) ) ?gen328 <- ( min_imprisonment ( negative-overruled $?gen333 ) )"))

([pen10-support] of derived-attribute-rule
   (pos-name pen10-support-gen648)
   (depends-on declare enabling_minor_extramarital_union_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen10] ) ) ) ?gen327 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ) ?gen328 <- ( min_imprisonment ( value 180 ) ( positive-support $?gen330 & : ( not ( subseq-pos ( create$ pen10 ?gen327 $$$ $?gen330 ) ) ) ) ) ( test ( eq ( class ?gen328 ) min_imprisonment ) ) => ( calc ( bind $?gen333 ( create$ pen10 ?gen327 $?gen330 ) ) ) ?gen328 <- ( min_imprisonment ( positive-support $?gen333 ) )"))

([pen9-defeasibly-dot] of derived-attribute-rule
   (pos-name pen9-defeasibly-dot-gen670)
   (depends-on declare max_imprisonment extramarital_union_with_minor_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen9] ) ) ) ?gen301 <- ( max_imprisonment ( value 1095 ) ( positive 1 ) ( positive-derivator pen9 $? ) ) ( test ( eq ( class ?gen301 ) max_imprisonment ) ) ( not ( and ?gen308 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ( positive ?gen307 & : ( >= ?gen307 1 ) ) ) ?gen301 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen303 & : ( not ( member$ pen9 $?gen303 ) ) ) ) ) ) => ?gen301 <- ( max_imprisonment ( positive 0 ) )"))

([pen9-defeasibly] of derived-attribute-rule
   (pos-name pen9-defeasibly-gen672)
   (depends-on declare extramarital_union_with_minor_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen9] ) ) ) ?gen308 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ( positive ?gen307 & : ( >= ?gen307 1 ) ) ) ?gen301 <- ( max_imprisonment ( value 1095 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen303 & : ( not ( member$ pen9 $?gen303 ) ) ) ) ( test ( eq ( class ?gen301 ) max_imprisonment ) ) => ?gen301 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen9 ?gen308 ) )"))

([pen9-overruled-dot] of derived-attribute-rule
   (pos-name pen9-overruled-dot-gen674)
   (depends-on declare max_imprisonment extramarital_union_with_minor_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen9] ) ) ) ?gen301 <- ( max_imprisonment ( value 1095 ) ( negative-support $?gen304 ) ( negative-overruled $?gen305 & : ( subseq-pos ( create$ pen9-overruled $?gen304 $$$ $?gen305 ) ) ) ) ( test ( eq ( class ?gen301 ) max_imprisonment ) ) ( not ( and ?gen308 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ( positive ?gen307 & : ( >= ?gen307 1 ) ) ) ?gen301 <- ( max_imprisonment ( positive-defeated $?gen303 & : ( not ( member$ pen9 $?gen303 ) ) ) ) ) ) => ( calc ( bind $?gen306 ( delete-member$ $?gen305 ( create$ pen9-overruled $?gen304 ) ) ) ) ?gen301 <- ( max_imprisonment ( negative-overruled $?gen306 ) )"))

([pen9-overruled] of derived-attribute-rule
   (pos-name pen9-overruled-gen676)
   (depends-on declare extramarital_union_with_minor_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen9] ) ) ) ?gen308 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ( positive ?gen307 & : ( >= ?gen307 1 ) ) ) ?gen301 <- ( max_imprisonment ( value 1095 ) ( negative-support $?gen304 ) ( negative-overruled $?gen305 & : ( not ( subseq-pos ( create$ pen9-overruled $?gen304 $$$ $?gen305 ) ) ) ) ( positive-defeated $?gen303 & : ( not ( member$ pen9 $?gen303 ) ) ) ) ( test ( eq ( class ?gen301 ) max_imprisonment ) ) => ( calc ( bind $?gen306 ( create$ pen9-overruled $?gen304 $?gen305 ) ) ) ?gen301 <- ( max_imprisonment ( negative-overruled $?gen306 ) )"))

([pen9-support] of derived-attribute-rule
   (pos-name pen9-support-gen678)
   (depends-on declare extramarital_union_with_minor_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen9] ) ) ) ?gen300 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ) ?gen301 <- ( max_imprisonment ( value 1095 ) ( positive-support $?gen303 & : ( not ( subseq-pos ( create$ pen9 ?gen300 $$$ $?gen303 ) ) ) ) ) ( test ( eq ( class ?gen301 ) max_imprisonment ) ) => ( calc ( bind $?gen306 ( create$ pen9 ?gen300 $?gen303 ) ) ) ?gen301 <- ( max_imprisonment ( positive-support $?gen306 ) )"))

([pen8-defeasibly-dot] of derived-attribute-rule
   (pos-name pen8-defeasibly-dot-gen680)
   (depends-on declare min_imprisonment extramarital_union_with_minor_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen8] ) ) ) ?gen292 <- ( min_imprisonment ( value 90 ) ( positive 1 ) ( positive-derivator pen8 $? ) ) ( test ( eq ( class ?gen292 ) min_imprisonment ) ) ( not ( and ?gen299 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ( positive ?gen298 & : ( >= ?gen298 1 ) ) ) ?gen292 <- ( min_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen294 & : ( not ( member$ pen8 $?gen294 ) ) ) ) ) ) => ?gen292 <- ( min_imprisonment ( positive 0 ) )"))

([pen8-defeasibly] of derived-attribute-rule
   (pos-name pen8-defeasibly-gen682)
   (depends-on declare extramarital_union_with_minor_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen8] ) ) ) ?gen299 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ( positive ?gen298 & : ( >= ?gen298 1 ) ) ) ?gen292 <- ( min_imprisonment ( value 90 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen294 & : ( not ( member$ pen8 $?gen294 ) ) ) ) ( test ( eq ( class ?gen292 ) min_imprisonment ) ) => ?gen292 <- ( min_imprisonment ( positive 1 ) ( positive-derivator pen8 ?gen299 ) )"))

([pen8-overruled-dot] of derived-attribute-rule
   (pos-name pen8-overruled-dot-gen684)
   (depends-on declare min_imprisonment extramarital_union_with_minor_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen8] ) ) ) ?gen292 <- ( min_imprisonment ( value 90 ) ( negative-support $?gen295 ) ( negative-overruled $?gen296 & : ( subseq-pos ( create$ pen8-overruled $?gen295 $$$ $?gen296 ) ) ) ) ( test ( eq ( class ?gen292 ) min_imprisonment ) ) ( not ( and ?gen299 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ( positive ?gen298 & : ( >= ?gen298 1 ) ) ) ?gen292 <- ( min_imprisonment ( positive-defeated $?gen294 & : ( not ( member$ pen8 $?gen294 ) ) ) ) ) ) => ( calc ( bind $?gen297 ( delete-member$ $?gen296 ( create$ pen8-overruled $?gen295 ) ) ) ) ?gen292 <- ( min_imprisonment ( negative-overruled $?gen297 ) )"))

([pen8-overruled] of derived-attribute-rule
   (pos-name pen8-overruled-gen686)
   (depends-on declare extramarital_union_with_minor_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen8] ) ) ) ?gen299 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ( positive ?gen298 & : ( >= ?gen298 1 ) ) ) ?gen292 <- ( min_imprisonment ( value 90 ) ( negative-support $?gen295 ) ( negative-overruled $?gen296 & : ( not ( subseq-pos ( create$ pen8-overruled $?gen295 $$$ $?gen296 ) ) ) ) ( positive-defeated $?gen294 & : ( not ( member$ pen8 $?gen294 ) ) ) ) ( test ( eq ( class ?gen292 ) min_imprisonment ) ) => ( calc ( bind $?gen297 ( create$ pen8-overruled $?gen295 $?gen296 ) ) ) ?gen292 <- ( min_imprisonment ( negative-overruled $?gen297 ) )"))

([pen8-support] of derived-attribute-rule
   (pos-name pen8-support-gen688)
   (depends-on declare extramarital_union_with_minor_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen8] ) ) ) ?gen291 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ) ?gen292 <- ( min_imprisonment ( value 90 ) ( positive-support $?gen294 & : ( not ( subseq-pos ( create$ pen8 ?gen291 $$$ $?gen294 ) ) ) ) ) ( test ( eq ( class ?gen292 ) min_imprisonment ) ) => ( calc ( bind $?gen297 ( create$ pen8 ?gen291 $?gen294 ) ) ) ?gen292 <- ( min_imprisonment ( positive-support $?gen297 ) )"))

([pen7-defeasibly-dot] of derived-attribute-rule
   (pos-name pen7-defeasibly-dot-gen700)
   (depends-on declare max_imprisonment family_obligation_violation_aggravated_health max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen7] ) ) ) ?gen274 <- ( max_imprisonment ( value 2920 ) ( positive 1 ) ( positive-derivator pen7 $? ) ) ( test ( eq ( class ?gen274 ) max_imprisonment ) ) ( not ( and ?gen281 <- ( family_obligation_violation_aggravated_health ( defendant ?Defendant ) ( positive ?gen280 & : ( >= ?gen280 1 ) ) ) ?gen274 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen276 & : ( not ( member$ pen7 $?gen276 ) ) ) ) ) ) => ?gen274 <- ( max_imprisonment ( positive 0 ) )"))

([pen7-defeasibly] of derived-attribute-rule
   (pos-name pen7-defeasibly-gen702)
   (depends-on declare family_obligation_violation_aggravated_health max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen7] ) ) ) ?gen281 <- ( family_obligation_violation_aggravated_health ( defendant ?Defendant ) ( positive ?gen280 & : ( >= ?gen280 1 ) ) ) ?gen274 <- ( max_imprisonment ( value 2920 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen276 & : ( not ( member$ pen7 $?gen276 ) ) ) ) ( test ( eq ( class ?gen274 ) max_imprisonment ) ) => ?gen274 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen7 ?gen281 ) )"))

([pen7-overruled-dot] of derived-attribute-rule
   (pos-name pen7-overruled-dot-gen704)
   (depends-on declare max_imprisonment family_obligation_violation_aggravated_health max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen7] ) ) ) ?gen274 <- ( max_imprisonment ( value 2920 ) ( negative-support $?gen277 ) ( negative-overruled $?gen278 & : ( subseq-pos ( create$ pen7-overruled $?gen277 $$$ $?gen278 ) ) ) ) ( test ( eq ( class ?gen274 ) max_imprisonment ) ) ( not ( and ?gen281 <- ( family_obligation_violation_aggravated_health ( defendant ?Defendant ) ( positive ?gen280 & : ( >= ?gen280 1 ) ) ) ?gen274 <- ( max_imprisonment ( positive-defeated $?gen276 & : ( not ( member$ pen7 $?gen276 ) ) ) ) ) ) => ( calc ( bind $?gen279 ( delete-member$ $?gen278 ( create$ pen7-overruled $?gen277 ) ) ) ) ?gen274 <- ( max_imprisonment ( negative-overruled $?gen279 ) )"))

([pen7-overruled] of derived-attribute-rule
   (pos-name pen7-overruled-gen706)
   (depends-on declare family_obligation_violation_aggravated_health max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen7] ) ) ) ?gen281 <- ( family_obligation_violation_aggravated_health ( defendant ?Defendant ) ( positive ?gen280 & : ( >= ?gen280 1 ) ) ) ?gen274 <- ( max_imprisonment ( value 2920 ) ( negative-support $?gen277 ) ( negative-overruled $?gen278 & : ( not ( subseq-pos ( create$ pen7-overruled $?gen277 $$$ $?gen278 ) ) ) ) ( positive-defeated $?gen276 & : ( not ( member$ pen7 $?gen276 ) ) ) ) ( test ( eq ( class ?gen274 ) max_imprisonment ) ) => ( calc ( bind $?gen279 ( create$ pen7-overruled $?gen277 $?gen278 ) ) ) ?gen274 <- ( max_imprisonment ( negative-overruled $?gen279 ) )"))

([pen7-support] of derived-attribute-rule
   (pos-name pen7-support-gen708)
   (depends-on declare family_obligation_violation_aggravated_health max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen7] ) ) ) ?gen273 <- ( family_obligation_violation_aggravated_health ( defendant ?Defendant ) ) ?gen274 <- ( max_imprisonment ( value 2920 ) ( positive-support $?gen276 & : ( not ( subseq-pos ( create$ pen7 ?gen273 $$$ $?gen276 ) ) ) ) ) ( test ( eq ( class ?gen274 ) max_imprisonment ) ) => ( calc ( bind $?gen279 ( create$ pen7 ?gen273 $?gen276 ) ) ) ?gen274 <- ( max_imprisonment ( positive-support $?gen279 ) )"))

([pen6-defeasibly-dot] of derived-attribute-rule
   (pos-name pen6-defeasibly-dot-gen720)
...
([pen6-defeasibly] of derived-attribute-rule
   (pos-name pen6-defeasibly-gen722)
...
([pen6-overruled-dot] of derived-attribute-rule
   (pos-name pen6-overruled-dot-gen724)
   (depends-on declare min_imprisonment family_obligation_violation_aggravated_health min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
...
([pen6-overruled] of derived-attribute-rule
   (pos-name pen6-overruled-gen726)
   (depends-on declare family_obligation_violation_aggravated_health min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
...
([pen5-defeasibly-dot] of derived-attribute-rule
   (pos-name pen5-defeasibly-dot-gen730)
...
([pen5-defeasibly] of derived-attribute-rule
   (pos-name pen5-defeasibly-gen732)
...
([pen5-overruled-dot] of derived-attribute-rule
   (pos-name pen5-overruled-dot-gen734)
   (depends-on declare max_imprisonment family_obligation_violation_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
...
([pen5-overruled] of derived-attribute-rule
   (pos-name pen5-overruled-gen736)
   (depends-on declare family_obligation_violation_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
...
([pen4-defeasibly-dot] of derived-attribute-rule
   (pos-name pen4-defeasibly-dot-gen740)
...
([pen4-defeasibly] of derived-attribute-rule
   (pos-name pen4-defeasibly-gen742)
...
([pen4-overruled-dot] of derived-attribute-rule
   (pos-name pen4-overruled-dot-gen744)
   (depends-on declare min_imprisonment family_obligation_violation_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
...
([pen4-overruled] of derived-attribute-rule
   (pos-name pen4-overruled-gen746)
   (depends-on declare family_obligation_violation_basic min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
...
([pen3-defeasibly-dot] of derived-attribute-rule
   (pos-name pen3-defeasibly-dot-gen750)
...
([pen3-defeasibly] of derived-attribute-rule
   (pos-name pen3-defeasibly-gen752)
...
([pen3-overruled-dot] of derived-attribute-rule
   (pos-name pen3-overruled-dot-gen754)
   (depends-on declare max_imprisonment failure_to_provide_support_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
...
([pen3-overruled] of derived-attribute-rule
   (pos-name pen3-overruled-gen756)
   (depends-on declare failure_to_provide_support_aggravated max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
...
([pen2-defeasibly-dot] of derived-attribute-rule
   (pos-name pen2-defeasibly-dot-gen760)
...
([pen2-defeasibly] of derived-attribute-rule
   (pos-name pen2-defeasibly-gen762)
...
([pen2-overruled-dot] of derived-attribute-rule
   (pos-name pen2-overruled-dot-gen764)
   (depends-on declare min_imprisonment failure_to_provide_support_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
...
([pen2-overruled] of derived-attribute-rule
   (pos-name pen2-overruled-gen766)
   (depends-on declare failure_to_provide_support_aggravated min_imprisonment)
   (implies min_imprisonment)
   (del-name nil)
...
([pen1-defeasibly-dot] of derived-attribute-rule
   (pos-name pen1-defeasibly-dot-gen770)
...
([pen1-defeasibly] of derived-attribute-rule
   (pos-name pen1-defeasibly-gen772)
...
([pen1-overruled-dot] of derived-attribute-rule
   (pos-name pen1-overruled-dot-gen774)
   (depends-on declare max_imprisonment failure_to_provide_support_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
...
([pen1-overruled] of derived-attribute-rule
   (pos-name pen1-overruled-gen776)
   (depends-on declare failure_to_provide_support_basic max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
...
([rule16-defeasibly-dot] of derived-attribute-rule
   (pos-name rule16-defeasibly-dot-gen780)
...
([rule16-defeasibly] of derived-attribute-rule
   (pos-name rule16-defeasibly-gen782)
...
([rule16-overruled-dot] of derived-attribute-rule
   (pos-name rule16-overruled-dot-gen784)
   (depends-on declare domestic_violence_protection_violation lc:case domestic_violence_protection_violation)
   (implies domestic_violence_protection_violation)
   (del-name nil)
...
([rule16-overruled] of derived-attribute-rule
   (pos-name rule16-overruled-gen786)
   (depends-on declare lc:case domestic_violence_protection_violation)
   (implies domestic_violence_protection_violation)
   (del-name nil)
...
([rule16-support] of derived-attribute-rule
   (pos-name rule16-support-gen788)
   (depends-on declare lc:case domestic_violence_protection_violation)
   (implies domestic_violence_protection_violation)
   (del-name nil)
...
([rule15-defeasibly-dot] of derived-attribute-rule
   (pos-name rule15-defeasibly-dot-gen790)
...
([rule15-defeasibly] of derived-attribute-rule
   (pos-name rule15-defeasibly-gen792)
...
([rule15-overruled-dot] of derived-attribute-rule
   (pos-name rule15-overruled-dot-gen794)
   (depends-on declare domestic_violence_aggravated_death lc:case lc:case lc:case domestic_violence_aggravated_death)
   (implies domestic_violence_aggravated_death)
   (del-name nil)
...
([rule15-overruled] of derived-attribute-rule
   (pos-name rule15-overruled-gen796)
   (depends-on declare lc:case lc:case lc:case domestic_violence_aggravated_death)
   (implies domestic_violence_aggravated_death)
   (del-name nil)
...
([rule15-support] of derived-attribute-rule
   (pos-name rule15-support-gen798)
   (depends-on declare lc:case lc:case lc:case domestic_violence_aggravated_death)
   (implies domestic_violence_aggravated_death)
   (del-name nil)
...
([rule14-defeated-dot] of derived-attribute-rule
   (pos-name rule14-defeated-dot-gen800)
...
([rule14-defeated] of derived-attribute-rule
   (pos-name rule14-defeated-gen802)
...
([rule14-defeasibly-dot] of derived-attribute-rule
   (pos-name rule14-defeasibly-dot-gen804)
...
([rule14-defeasibly] of derived-attribute-rule
   (pos-name rule14-defeasibly-gen806)
   (depends-on declare lc:case lc:case domestic_violence_aggravated_severe)
   (implies domestic_violence_aggravated_severe)
   (del-name nil)
...
([rule14-overruled-dot] of derived-attribute-rule
   (pos-name rule14-overruled-dot-gen808)
   (depends-on declare domestic_violence_aggravated_severe lc:case lc:case domestic_violence_aggravated_severe)
   (implies domestic_violence_aggravated_severe)
   (del-name nil)
...
([rule14-overruled] of derived-attribute-rule
   (pos-name rule14-overruled-gen810)
   (depends-on declare lc:case lc:case domestic_violence_aggravated_severe)
   (implies domestic_violence_aggravated_severe)
   (del-name nil)
...
([rule14-support] of derived-attribute-rule
   (pos-name rule14-support-gen812)
   (depends-on declare lc:case lc:case domestic_violence_aggravated_severe)
   (implies domestic_violence_aggravated_severe)
   (del-name nil)
...
([rule13-defeated-dot] of derived-attribute-rule
   (pos-name rule13-defeated-dot-gen814)
...
([rule13-defeated] of derived-attribute-rule
   (pos-name rule13-defeated-gen816)
...
([rule13-defeasibly-dot] of derived-attribute-rule
   (pos-name rule13-defeasibly-dot-gen818)
...
([rule13-defeasibly] of derived-attribute-rule
   (pos-name rule13-defeasibly-gen820)
   (depends-on declare lc:case lc:case domestic_violence_aggravated_weapon)
   (implies domestic_violence_aggravated_weapon)
   (del-name nil)
...
([rule13-overruled-dot] of derived-attribute-rule
   (pos-name rule13-overruled-dot-gen822)
   (depends-on declare domestic_violence_aggravated_weapon lc:case lc:case domestic_violence_aggravated_weapon)
   (implies domestic_violence_aggravated_weapon)
   (del-name nil)
...
([rule13-overruled] of derived-attribute-rule
   (pos-name rule13-overruled-gen824)
   (depends-on declare lc:case lc:case domestic_violence_aggravated_weapon)
   (implies domestic_violence_aggravated_weapon)
   (del-name nil)
...
([rule13-support] of derived-attribute-rule
   (pos-name rule13-support-gen826)
   (depends-on declare lc:case lc:case domestic_violence_aggravated_weapon)
   (implies domestic_violence_aggravated_weapon)
   (del-name nil)
...
([rule12-defeated-dot] of derived-attribute-rule
   (pos-name rule12-defeated-dot-gen828)
...
([rule12-defeated] of derived-attribute-rule
   (pos-name rule12-defeated-gen830)
...
([rule12-defeasibly-dot] of derived-attribute-rule
   (pos-name rule12-defeasibly-dot-gen832)
...
([rule12-defeasibly] of derived-attribute-rule
   (pos-name rule12-defeasibly-gen834)
   (depends-on declare lc:case domestic_violence_basic)
   (implies domestic_violence_basic)
   (del-name nil)
...
([rule12-overruled-dot] of derived-attribute-rule
   (pos-name rule12-overruled-dot-gen836)
   (depends-on declare domestic_violence_basic lc:case domestic_violence_basic)
   (implies domestic_violence_basic)
   (del-name nil)
...
([rule12-overruled] of derived-attribute-rule
   (pos-name rule12-overruled-gen838)
   (depends-on declare lc:case domestic_violence_basic)
   (implies domestic_violence_basic)
   (del-name nil)
...
([rule12-support] of derived-attribute-rule
   (pos-name rule12-support-gen840)
   (depends-on declare lc:case domestic_violence_basic)
   (implies domestic_violence_basic)
   (del-name nil)
...
([rule11-defeasibly-dot] of derived-attribute-rule
   (pos-name rule11-defeasibly-dot-gen842)
...
([rule11-defeasibly] of derived-attribute-rule
   (pos-name rule11-defeasibly-gen844)
...
([rule11-overruled-dot] of derived-attribute-rule
   (pos-name rule11-overruled-dot-gen846)
   (depends-on declare child_abduction_aggravated lc:case lc:case child_abduction_aggravated)
   (implies child_abduction_aggravated)
   (del-name nil)
...
([rule11-overruled] of derived-attribute-rule
   (pos-name rule11-overruled-gen848)
   (depends-on declare lc:case lc:case child_abduction_aggravated)
   (implies child_abduction_aggravated)
   (del-name nil)
...
([rule11-support] of derived-attribute-rule
   (pos-name rule11-support-gen850)
   (depends-on declare lc:case lc:case child_abduction_aggravated)
   (implies child_abduction_aggravated)
   (del-name nil)
...
([rule10-defeasibly-dot] of derived-attribute-rule
   (pos-name rule10-defeasibly-dot-gen852)
...
([rule10-defeasibly] of derived-attribute-rule
   (pos-name rule10-defeasibly-gen854)
...
([rule10-overruled-dot] of derived-attribute-rule
   (pos-name rule10-overruled-dot-gen856)
   (depends-on declare preventing_child_contact lc:case preventing_child_contact)
   (implies preventing_child_contact)
   (del-name nil)
...
([rule10-overruled] of derived-attribute-rule
   (pos-name rule10-overruled-gen858)
   (depends-on declare lc:case preventing_child_contact)
   (implies preventing_child_contact)
   (del-name nil)
...
([rule10-support] of derived-attribute-rule
   (pos-name rule10-support-gen860)
   (depends-on declare lc:case preventing_child_contact)
   (implies preventing_child_contact)
   (del-name nil)
...
([rule9-defeated-dot] of derived-attribute-rule
   (pos-name rule9-defeated-dot-gen862)
...
([rule9-defeated] of derived-attribute-rule
   (pos-name rule9-defeated-gen864)
...
([rule9-defeasibly-dot] of derived-attribute-rule
   (pos-name rule9-defeasibly-dot-gen866)
...
([rule9-defeasibly] of derived-attribute-rule
   (pos-name rule9-defeasibly-gen868)
   (depends-on declare lc:case child_abduction_basic)
   (implies child_abduction_basic)
   (del-name nil)
...
([rule9-overruled-dot] of derived-attribute-rule
   (pos-name rule9-overruled-dot-gen870)
   (depends-on declare child_abduction_basic lc:case child_abduction_basic)
   (implies child_abduction_basic)
   (del-name nil)
...
([rule9-overruled] of derived-attribute-rule
   (pos-name rule9-overruled-gen872)
   (depends-on declare lc:case child_abduction_basic)
   (implies child_abduction_basic)
   (del-name nil)
...
([rule8-defeasibly-dot] of derived-attribute-rule
   (pos-name rule8-defeasibly-dot-gen876)
...
([rule8-defeasibly] of derived-attribute-rule
   (pos-name rule8-defeasibly-gen878)
...
([rule8-overruled-dot] of derived-attribute-rule
   (pos-name rule8-overruled-dot-gen880)
   (depends-on declare enabling_minor_extramarital_union_aggravated lc:case lc:case lc:case enabling_minor_extramarital_union_aggravated)
   (implies enabling_minor_extramarital_union_aggravated)
   (del-name nil)
...
([rule8-overruled] of derived-attribute-rule
   (pos-name rule8-overruled-gen882)
   (depends-on declare lc:case lc:case lc:case enabling_minor_extramarital_union_aggravated)
   (implies enabling_minor_extramarital_union_aggravated)
   (del-name nil)
...
([rule7-defeated-dot] of derived-attribute-rule
   (pos-name rule7-defeated-dot-gen886)
...
([rule7-defeated] of derived-attribute-rule
   (pos-name rule7-defeated-gen888)
...
([rule7-defeasibly-dot] of derived-attribute-rule
   (pos-name rule7-defeasibly-dot-gen890)
...
([rule7-defeasibly] of derived-attribute-rule
   (pos-name rule7-defeasibly-gen892)
   (depends-on declare lc:case lc:case enabling_minor_extramarital_union)
   (implies enabling_minor_extramarital_union)
   (del-name nil)
...
([rule7-overruled-dot] of derived-attribute-rule
   (pos-name rule7-overruled-dot-gen894)
   (depends-on declare enabling_minor_extramarital_union lc:case lc:case enabling_minor_extramarital_union)
   (implies enabling_minor_extramarital_union)
   (del-name nil)
...
([rule7-overruled] of derived-attribute-rule
   (pos-name rule7-overruled-gen896)
   (depends-on declare lc:case lc:case enabling_minor_extramarital_union)
   (implies enabling_minor_extramarital_union)
   (del-name nil)
...
([rule6-defeasibly-dot] of derived-attribute-rule
   (pos-name rule6-defeasibly-dot-gen900)
...
([rule6-defeasibly] of derived-attribute-rule
   (pos-name rule6-defeasibly-gen902)
...
([rule6-overruled-dot] of derived-attribute-rule
   (pos-name rule6-overruled-dot-gen904)
   (depends-on declare extramarital_union_with_minor_basic lc:case lc:case extramarital_union_with_minor_basic)
   (implies extramarital_union_with_minor_basic)
   (del-name nil)
...
([rule6-overruled] of derived-attribute-rule
   (pos-name rule6-overruled-gen906)
   (depends-on declare lc:case lc:case extramarital_union_with_minor_basic)
   (implies extramarital_union_with_minor_basic)
   (del-name nil)
...
([rule5-defeasibly-dot] of derived-attribute-rule
   (pos-name rule5-defeasibly-dot-gen910)
...
([rule5-defeasibly] of derived-attribute-rule
   (pos-name rule5-defeasibly-gen912)
...
([rule5-overruled-dot] of derived-attribute-rule
   (pos-name rule5-overruled-dot-gen914)
   (depends-on declare family_obligation_violation_aggravated_death lc:case lc:case lc:case family_obligation_violation_aggravated_death)
   (implies family_obligation_violation_aggravated_death)
   (del-name nil)
...
([rule5-overruled] of derived-attribute-rule
   (pos-name rule5-overruled-gen916)
   (depends-on declare lc:case lc:case lc:case family_obligation_violation_aggravated_death)
   (implies family_obligation_violation_aggravated_death)
   (del-name nil)
...
([rule4-defeated-dot] of derived-attribute-rule
   (pos-name rule4-defeated-dot-gen920)
...
([rule4-defeated] of derived-attribute-rule
   (pos-name rule4-defeated-gen922)
...
([rule4-defeasibly-dot] of derived-attribute-rule
   (pos-name rule4-defeasibly-dot-gen924)
...
([rule4-defeasibly] of derived-attribute-rule
   (pos-name rule4-defeasibly-gen926)
   (depends-on declare lc:case lc:case lc:case family_obligation_violation_aggravated_health)
   (implies family_obligation_violation_aggravated_health)
   (del-name nil)
...
([rule4-overruled-dot] of derived-attribute-rule
   (pos-name rule4-overruled-dot-gen928)
   (depends-on declare family_obligation_violation_aggravated_health lc:case lc:case lc:case family_obligation_violation_aggravated_health)
   (implies family_obligation_violation_aggravated_health)
   (del-name nil)
...
([rule4-overruled] of derived-attribute-rule
   (pos-name rule4-overruled-gen930)
   (depends-on declare lc:case lc:case lc:case family_obligation_violation_aggravated_health)
   (implies family_obligation_violation_aggravated_health)
   (del-name nil)
...
([rule3-defeated-dot] of derived-attribute-rule
   (pos-name rule3-defeated-dot-gen934)
...
([rule3-defeated] of derived-attribute-rule
   (pos-name rule3-defeated-gen936)
...
([rule3-defeasibly-dot] of derived-attribute-rule
   (pos-name rule3-defeasibly-dot-gen938)
...
([rule3-defeasibly] of derived-attribute-rule
   (pos-name rule3-defeasibly-gen940)
   (depends-on declare lc:case lc:case family_obligation_violation_basic)
   (implies family_obligation_violation_basic)
   (del-name nil)
...
([rule3-overruled-dot] of derived-attribute-rule
   (pos-name rule3-overruled-dot-gen942)
   (depends-on declare family_obligation_violation_basic lc:case lc:case family_obligation_violation_basic)
   (implies family_obligation_violation_basic)
   (del-name nil)
...
([rule3-overruled] of derived-attribute-rule
   (pos-name rule3-overruled-gen944)
   (depends-on declare lc:case lc:case family_obligation_violation_basic)
   (implies family_obligation_violation_basic)
   (del-name nil)
...
([rule2-defeasibly-dot] of derived-attribute-rule
   (pos-name rule2-defeasibly-dot-gen948)
...
([rule2-defeasibly] of derived-attribute-rule
   (pos-name rule2-defeasibly-gen950)
...
([rule2-overruled-dot] of derived-attribute-rule
   (pos-name rule2-overruled-dot-gen952)
   (depends-on declare failure_to_provide_support_aggravated lc:case lc:case lc:case failure_to_provide_support_aggravated)
   (implies failure_to_provide_support_aggravated)
   (del-name nil)
...
([rule2-overruled] of derived-attribute-rule
   (pos-name rule2-overruled-gen954)
   (depends-on declare lc:case lc:case lc:case failure_to_provide_support_aggravated)
   (implies failure_to_provide_support_aggravated)
   (del-name nil)
...
([rule1-defeated-dot] of derived-attribute-rule
   (pos-name rule1-defeated-dot-gen958)
...
([rule1-defeated] of derived-attribute-rule
   (pos-name rule1-defeated-gen960)
...
([rule1-defeasibly-dot] of derived-attribute-rule
   (pos-name rule1-defeasibly-dot-gen962)
...
([rule1-defeasibly] of derived-attribute-rule
   (pos-name rule1-defeasibly-gen964)
   (depends-on declare lc:case lc:case failure_to_provide_support_basic)
   (implies failure_to_provide_support_basic)
   (del-name nil)
...
([rule1-overruled-dot] of derived-attribute-rule
   (pos-name rule1-overruled-dot-gen966)
   (depends-on declare failure_to_provide_support_basic lc:case lc:case failure_to_provide_support_basic)
   (implies failure_to_provide_support_basic)
   (del-name nil)
...
([rule1-overruled] of derived-attribute-rule
   (pos-name rule1-overruled-gen968)
   (depends-on declare lc:case lc:case failure_to_provide_support_basic)
   (implies failure_to_provide_support_basic)
   (del-name nil)
...
([pen22-deductive] of ntm-deductive-rule
   (pos-name pen22-deductive-gen499)
   (depends-on domestic_violence_protection_violation max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen453 <- ( domestic_violence_protection_violation ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 365 ) ) ) => ( max_imprisonment ( value 365 ) )")
   (production-rule "( defrule pen22-deductive-gen499 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen453 ) ( is-a domestic_violence_protection_violation ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 365 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 365 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 365 ) ) ) ( make-instance ?oid of max_imprisonment ( value 365 ) ) )")
   (derived-class max_imprisonment))

([pen21-deductive] of ntm-deductive-rule
   (pos-name pen21-deductive-gen498)
   (depends-on domestic_violence_aggravated_death max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen444 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 5475 ) ) ) => ( max_imprisonment ( value 5475 ) )")
   (production-rule "( defrule pen21-deductive-gen498 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen444 ) ( is-a domestic_violence_aggravated_death ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 5475 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 5475 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 5475 ) ) ) ( make-instance ?oid of max_imprisonment ( value 5475 ) ) )")
   (derived-class max_imprisonment))

([pen20-deductive] of ntm-deductive-rule
   (pos-name pen20-deductive-gen497)
   (depends-on domestic_violence_aggravated_death min_imprisonment)
   (implies min_imprisonment)
   (deductive-rule "?gen435 <- ( domestic_violence_aggravated_death ( defendant ?Defendant ) ) ( not ( min_imprisonment ( value 1825 ) ) ) => ( min_imprisonment ( value 1825 ) )")
   (production-rule "( defrule pen20-deductive-gen497 ( declare ( salience ( calc-salience min_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen435 ) ( is-a domestic_violence_aggravated_death ) ( defendant ?Defendant ) ) ( not ( object ( is-a min_imprisonment ) ( value 1825 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat min_imprisonment 1825 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat min_imprisonment 1825 ) ) ) ( make-instance ?oid of min_imprisonment ( value 1825 ) ) )")
   (derived-class min_imprisonment))

([pen19-deductive] of ntm-deductive-rule
   (pos-name pen19-deductive-gen496)
   (depends-on domestic_violence_aggravated_severe max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen426 <- ( domestic_violence_aggravated_severe ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 2920 ) ) ) => ( max_imprisonment ( value 2920 ) )")
   (production-rule "( defrule pen19-deductive-gen496 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen426 ) ( is-a domestic_violence_aggravated_severe ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 2920 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 2920 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 2920 ) ) ) ( make-instance ?oid of max_imprisonment ( value 2920 ) ) )")
   (derived-class max_imprisonment))

([pen18-deductive] of ntm-deductive-rule
   (pos-name pen18-deductive-gen495)
   (depends-on domestic_violence_aggravated_weapon min_imprisonment)
   (implies min_imprisonment)
   (deductive-rule "?gen399 <- ( domestic_violence_aggravated_weapon ( defendant ?Defendant ) ) ( not ( min_imprisonment ( value 365 ) ) ) => ( min_imprisonment ( value 365 ) )")
   (production-rule "( defrule pen18-deductive-gen495 ( declare ( salience ( calc-salience min_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen399 ) ( is-a domestic_violence_aggravated_weapon ) ( defendant ?Defendant ) ) ( not ( object ( is-a min_imprisonment ) ( value 365 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat min_imprisonment 365 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat min_imprisonment 365 ) ) ) ( make-instance ?oid of min_imprisonment ( value 365 ) ) )")
   (derived-class min_imprisonment))

([pen17-deductive] of ntm-deductive-rule
   (pos-name pen17-deductive-gen494)
   (depends-on domestic_violence_basic max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen390 <- ( domestic_violence_basic ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 1825 ) ) ) => ( max_imprisonment ( value 1825 ) )")
   (production-rule "( defrule pen17-deductive-gen494 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen390 ) ( is-a domestic_violence_basic ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 1825 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 1825 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 1825 ) ) ) ( make-instance ?oid of max_imprisonment ( value 1825 ) ) )")
   (derived-class max_imprisonment))

([pen16-deductive] of ntm-deductive-rule
   (pos-name pen16-deductive-gen493)
   (depends-on domestic_violence_basic min_imprisonment)
   (implies min_imprisonment)
   (deductive-rule "?gen381 <- ( domestic_violence_basic ( defendant ?Defendant ) ) ( not ( min_imprisonment ( value 180 ) ) ) => ( min_imprisonment ( value 180 ) )")
   (production-rule "( defrule pen16-deductive-gen493 ( declare ( salience ( calc-salience min_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen381 ) ( is-a domestic_violence_basic ) ( defendant ?Defendant ) ) ( not ( object ( is-a min_imprisonment ) ( value 180 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat min_imprisonment 180 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat min_imprisonment 180 ) ) ) ( make-instance ?oid of min_imprisonment ( value 180 ) ) )")
   (derived-class min_imprisonment))

([pen15-deductive] of ntm-deductive-rule
   (pos-name pen15-deductive-gen492)
   (depends-on child_abduction_aggravated max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen372 <- ( child_abduction_aggravated ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 1825 ) ) ) => ( max_imprisonment ( value 1825 ) )")
   (production-rule "( defrule pen15-deductive-gen492 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen372 ) ( is-a child_abduction_aggravated ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 1825 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 1825 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 1825 ) ) ) ( make-instance ?oid of max_imprisonment ( value 1825 ) ) )")
   (derived-class max_imprisonment))

([pen14-deductive] of ntm-deductive-rule
   (pos-name pen14-deductive-gen491)
   (depends-on child_abduction_aggravated min_imprisonment)
   (implies min_imprisonment)
   (deductive-rule "?gen363 <- ( child_abduction_aggravated ( defendant ?Defendant ) ) ( not ( min_imprisonment ( value 90 ) ) ) => ( min_imprisonment ( value 90 ) )")
   (production-rule "( defrule pen14-deductive-gen491 ( declare ( salience ( calc-salience min_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen363 ) ( is-a child_abduction_aggravated ) ( defendant ?Defendant ) ) ( not ( object ( is-a min_imprisonment ) ( value 90 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat min_imprisonment 90 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat min_imprisonment 90 ) ) ) ( make-instance ?oid of min_imprisonment ( value 90 ) ) )")
   (derived-class min_imprisonment))

([pen13-deductive] of ntm-deductive-rule
   (pos-name pen13-deductive-gen490)
   (depends-on preventing_child_contact max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen354 <- ( preventing_child_contact ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 365 ) ) ) => ( max_imprisonment ( value 365 ) )")
   (production-rule "( defrule pen13-deductive-gen490 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen354 ) ( is-a preventing_child_contact ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 365 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 365 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 365 ) ) ) ( make-instance ?oid of max_imprisonment ( value 365 ) ) )")
   (derived-class max_imprisonment))

([pen12-deductive] of ntm-deductive-rule
   (pos-name pen12-deductive-gen489)
   (depends-on child_abduction_basic max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen345 <- ( child_abduction_basic ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 730 ) ) ) => ( max_imprisonment ( value 730 ) )")
   (production-rule "( defrule pen12-deductive-gen489 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen345 ) ( is-a child_abduction_basic ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 730 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 730 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 730 ) ) ) ( make-instance ?oid of max_imprisonment ( value 730 ) ) )")
   (derived-class max_imprisonment))

([pen11-deductive] of ntm-deductive-rule
   (pos-name pen11-deductive-gen488)
   (depends-on enabling_minor_extramarital_union_aggravated max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen336 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 1825 ) ) ) => ( max_imprisonment ( value 1825 ) )")
   (production-rule "( defrule pen11-deductive-gen488 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen336 ) ( is-a enabling_minor_extramarital_union_aggravated ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 1825 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 1825 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 1825 ) ) ) ( make-instance ?oid of max_imprisonment ( value 1825 ) ) )")
   (derived-class max_imprisonment))

([pen10-deductive] of ntm-deductive-rule
   (pos-name pen10-deductive-gen487)
   (depends-on enabling_minor_extramarital_union_aggravated min_imprisonment)
   (implies min_imprisonment)
   (deductive-rule "?gen327 <- ( enabling_minor_extramarital_union_aggravated ( defendant ?Defendant ) ) ( not ( min_imprisonment ( value 180 ) ) ) => ( min_imprisonment ( value 180 ) )")
   (production-rule "( defrule pen10-deductive-gen487 ( declare ( salience ( calc-salience min_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen327 ) ( is-a enabling_minor_extramarital_union_aggravated ) ( defendant ?Defendant ) ) ( not ( object ( is-a min_imprisonment ) ( value 180 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat min_imprisonment 180 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat min_imprisonment 180 ) ) ) ( make-instance ?oid of min_imprisonment ( value 180 ) ) )")
   (derived-class min_imprisonment))

([pen9-deductive] of ntm-deductive-rule
   (pos-name pen9-deductive-gen486)
   (depends-on extramarital_union_with_minor_basic max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen300 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 1095 ) ) ) => ( max_imprisonment ( value 1095 ) )")
   (production-rule "( defrule pen9-deductive-gen486 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen300 ) ( is-a extramarital_union_with_minor_basic ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 1095 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 1095 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 1095 ) ) ) ( make-instance ?oid of max_imprisonment ( value 1095 ) ) )")
   (derived-class max_imprisonment))

([pen8-deductive] of ntm-deductive-rule
   (pos-name pen8-deductive-gen485)
   (depends-on extramarital_union_with_minor_basic min_imprisonment)
   (implies min_imprisonment)
   (deductive-rule "?gen291 <- ( extramarital_union_with_minor_basic ( defendant ?Defendant ) ) ( not ( min_imprisonment ( value 90 ) ) ) => ( min_imprisonment ( value 90 ) )")
   (production-rule "( defrule pen8-deductive-gen485 ( declare ( salience ( calc-salience min_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen291 ) ( is-a extramarital_union_with_minor_basic ) ( defendant ?Defendant ) ) ( not ( object ( is-a min_imprisonment ) ( value 90 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat min_imprisonment 90 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat min_imprisonment 90 ) ) ) ( make-instance ?oid of min_imprisonment ( value 90 ) ) )")
   (derived-class min_imprisonment))

([pen7-deductive] of ntm-deductive-rule
   (pos-name pen7-deductive-gen484)
   (depends-on family_obligation_violation_aggravated_health max_imprisonment)
   (implies max_imprisonment)
   (deductive-rule "?gen273 <- ( family_obligation_violation_aggravated_health ( defendant ?Defendant ) ) ( not ( max_imprisonment ( value 2920 ) ) ) => ( max_imprisonment ( value 2920 ) )")
   (production-rule "( defrule pen7-deductive-gen484 ( declare ( salience ( calc-salience max_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen273 ) ( is-a family_obligation_violation_aggravated_health ) ( defendant ?Defendant ) ) ( not ( object ( is-a max_imprisonment ) ( value 2920 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat max_imprisonment 2920 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat max_imprisonment 2920 ) ) ) ( make-instance ?oid of max_imprisonment ( value 2920 ) ) )")
   (derived-class max_imprisonment))

([pen6-deductive] of ntm-deductive-rule
   (pos-name pen6-deductive-gen483)
   ...
   (production-rule "( defrule pen6-deductive-gen483 ( declare ( salience ( calc-salience min_imprisonment ) ) ) ( run-deductive-rules ) ( object ( name ?gen255 ) ( is-a family_obligation_violation_aggravated_health ) ( defendant ?Defendant ) ) ( not ( object ( is-a min_imprisonment ) ( value 365 ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat min_imprisonment 365 ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat min_imprisonment 365 ) ) ) ( make-instance ?oid of min_imprisonment ( value 365 ) ) )")
   (derived-class min_imprisonment))

([pen5-deductive] of ntm-deductive-rule
   (pos-name pen5-deductive-gen482)
