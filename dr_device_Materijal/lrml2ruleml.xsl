...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="lrml:LegalRuleML">
        <RuleML>
            ...
            <xsl:attribute name="rdf_export_classes">failure_to_provide_support_basic failure_to_provide_support_aggravated max_imprisonment min_imprisonment</xsl:attribute>
    ...
    <xsl:template match="ruleml:Atom[ruleml:Rel[@iri] and ruleml:Ind]">
        ...
        <!-- Novi pattern za nase fajlove -->
    <xsl:template match="ruleml:Atom[ruleml:Rel[@iri] and ruleml:Var and ruleml:Data]">
        <Atom>
            <op><Rel uri="lc:case"/></op>
            <slot>
